...
export default function Realfooter(){
    return(
        <div className="px-2 py-1 bg-gray-100 text-gray-600 dark:bg-slate-800">
    ...
    <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
      <div>
        <p>
          ...
          <Link href="#" className="block text-2xl font-medium text-gray-900 hover:opacity-75 sm:text-3xl dark:text-white">
            o1o-219o-6oo8
          </Link>
        </p>
        </div>
