export default function Yonggyu(){
    return(
        <div className="w-5/6 m-auto">
            ...
            <img className="mask mask-hexagon-2 grayscale lg:w-96 md:w-64 w-32" src="/imgs/yong.jpg" />
            <div className=" translate-x-16"> 
            <h1 className="lg:text-2xl font-semibold mb-8 sm:text-lg text-base">김용규의 포트폴리오 페이지입니다.</h1>
            <p className="lg:text-lg sm:text-base text-sm">안녕하세요 반갑습니다.</p>
