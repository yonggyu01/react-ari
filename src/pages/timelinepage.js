				...
				<ul className="space-y-4">
					<li className="space-y-1">
						<div className="flex items-center space-x-2">
							...
							<h4 className="font-medium">2024-03 그린컴퓨터 학원 졸업</h4>
						</div>
						<p className="ml-7 dark:text-gray-400">웹앱 개발자 양성과정</p>
					</li>
					<li className="space-y-1">
						<div className="flex items-center space-x-2">
							<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-4 h-4 fill-current dark:text-blue-400">
				...
				<ul className="space-y-4">
					...
					<li className="space-y-1">
						<div className="flex items-center space-x-2">
							...
							<h4 className="font-medium">2023-09 그린컴퓨터 학원 - 웹앱 소프트웨어 개발자 양성과정 수업시작 </h4>
						</div>
