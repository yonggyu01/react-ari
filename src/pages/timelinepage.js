...
<section className="dark:bg-gray-800 dark:text-gray-100 h-full bg-white">
	<div className="container px-4 py-16 mx-auto space-y-8 lg:max-w-3xl">
		...
		<div className="space-y-8">
			<div>
				<h3 className="mb-3 text-lg font-bold md:text-xl">2024</h3>
				<ul className="space-y-4">
					...
					<li className="space-y-1">
						<div className="flex items-center space-x-2">
							...
							<h4 className="font-medium">2024-03-14 React Ari_fanpage 개발</h4>
						</div>
						<p className="ml-7 dark:text-gray-400"> React 활용한 포트폴리오 소개페이지 제작 </p>
					</li>
					<li className="space-y-1">
						<div className="flex items-center space-x-2">
							<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-4 h-4 fill-current dark:text-blue-400">
				...
				<ul className="space-y-4">
					...
					<li className="space-y-1">
						<div className="flex items-center space-x-2">
							...
							<h4 className="font-medium">2023-11 두번째 개인프로젝트</h4>
						</div>
						<p className="ml-7 dark:text-gray-400">Window 프로젝트 개발시작</p>
					</li>
					<li className="space-y-1">
						<div className="flex items-center space-x-2">
							<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-4 h-4 fill-current dark:text-blue-400">
					...
					<li className="space-y-1">
						<div className="flex items-center space-x-2">
							...
							<h4 className="font-medium">2023-09 그린컴퓨터 학원 - 프로젝트 기반 프론트엔드 웹앱 개발자 양성과정 수업시작 </h4>
						</div>
						<p className="ml-7 dark:text-gray-400">콘솔창에 Hello World 입력해봄</p>
					</li>
				</ul>
			</div>
		</div>
