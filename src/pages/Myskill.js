export default function Myskill(){
    ...
    <path d="m3 2 1.6 17.8L12 22l7.5-2.2L21 2H3Zm13.3 14.7L12 18l-4.3-1.2-.3-3.1h2.1l.2 1.5 2.3.6 2.3-.6.3-3H7.3l-.2-2h7.7l.1-2H7l-.2-2h10.6l-1 10.6Z"/>
            ...
            <div className="flex flex-col justify-center items-center">
            <img src="/imgs/sass-1.svg" alt="svg" className="w-12 h-12 mx-10 my-6 fill-current md:mx-12 lg:m-0 text-gray-600"/>
            <h3 className="text-xl font-bold md:text-4xl mt-2">SCSS</h3>
            </div>
            <div className="flex flex-col justify-center items-center">
			 
  <img src="/imgs/javascript-logo-svgrepo-com.svg" alt="svg" className="w-12 h-12 mx-10 my-6 fill-current md:mx-12 lg:m-0 text-gray-600"/>
            <h3 className="text-xl font-bold md:text-4xl mt-2">Javascript</h3>
            </div>
            <div className="flex flex-col justify-center items-center">
			 
  <img src="/imgs/typescript.svg" alt="svg" className="w-12 h-12 mx-10 my-6 fill-current md:mx-12 lg:m-0 text-gray-600"/>
            <h3 className="text-xl font-bold md:text-4xl mt-2">Typescript</h3>
            </div>
            <div className="flex flex-col justify-center items-center">
