...
export default function Myviewpage({Clicklogo}){
  ...
  >
    ...
    >
			<figure>
					<img alt="" id={`my_img${idx}`} className="object-fit w-full h-52 dark:bg-gray-500 rounded-lg object-center text-center" src={item.src} />
    ...
    >
      ...
      <p className="mt-8 font-bold">클릭시 이동</p>
				...
				<div className="modal-box ">
					...
					<button className="btn btn-outline btn-accent btn-sm" onClick={()=>{}}>Page info</button>
