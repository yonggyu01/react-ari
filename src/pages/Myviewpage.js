...
export default function Myviewpage(){
  ...
  <svg className="w-[35px] h-[35px] text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
	...
	<div className="container p-6 mx-auto space-y-8">
		...
		{mypage && mypage.map(item =>  <article className="card bg-white shadow-xl flex flex-col dark:bg-gray-900" key={item.id}>
				<a rel="noopener noreferrer" href="#none" aria-label="">
				<figure>
					<img alt="" className="object-fit w-full h-52 dark:bg-gray-500 rounded-lg object-center" src={item.src} />
					{/* https://source.unsplash.com/200x200/?fashion?1 */}
					</figure>
				</a>
				<div className="flex flex-col flex-1 p-6">
					<a rel="noopener noreferrer" href="#none" aria-label="Te nulla oportere reprimique his dolorum"></a>
					<a rel="noopener noreferrer" href="#none" className="text-lg tracki uppercase font-semibold hover:underline dark:text-violet-400">{item.title}</a>
